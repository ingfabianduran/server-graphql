module.exports = {
    ...
    dataForm: () => {
        const data = {
            ...
            tecnicos: ["Elige", "John Jairo Agudelo", "Julian Camilo Lopez", "Orlando Garcia Zapata", "Fabian Esteban Duran", "Ivan Arturo Ortiz", "David Stiven Martinez", "Sebastian Torres"],
